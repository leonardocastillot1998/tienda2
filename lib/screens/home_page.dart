  ...
  Widget _buildRewardProgress() {
    return FutureBuilder<Map<String, dynamic>?>(
      ...
      builder: (context, snapshot) {
        ...
        final hasRedeemableReward =
            data['hasRedeemableReward'] as bool? ?? false;
        final statusLabel =
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 12,
                color: PrestigeColors.onSurfaceVariant,
                fontWeight: hasRedeemableReward
                    ? FontWeight.bold
                    : FontWeight.normal,
              ),
            ),
      ...
      builder: (context, snapshot) {
        ...
        return GridView.count(
          ...
          children: records.map((product) {
            ...
            final rewardPoints =
                int.tryParse(product['points']?.toString() ?? '0') ?? 0;
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          await Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (_) => const PurchasesPage()));
